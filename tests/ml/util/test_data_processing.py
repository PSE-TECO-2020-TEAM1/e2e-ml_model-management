...
def test_roll_data_frame(sliding_window_5_1, sliding_window_4_2, interpolated_sample_list, data_windows_df_5_1, data_windows_df_4_2):
    sample_df = interpolated_sample_list[0].data_frame
    assert roll_data_frame(sliding_window_5_1, sample_df).equals(
        data_windows_df_5_1[0:int(0.5*len(data_windows_df_5_1.index))])
    assert roll_data_frame(sliding_window_4_2, sample_df).equals(
        data_windows_df_4_2[0:int(0.5*len(data_windows_df_4_2.index))])
